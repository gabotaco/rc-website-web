    ...
    return (
        ...
        <tbody>
            <tr>
                ...
                <td>{props.member.company !== 'fired' ? new Date(props.member.deadline).toDateString() : props.member.fire_reason}</td>
                <td>{props.member.company !== 'fired' ? new Date(props.member.last_turnin).toDateString() : new Date(props.member.deadline).toDateString()}</td>
            </tr>
        </tbody>
    </Table>
