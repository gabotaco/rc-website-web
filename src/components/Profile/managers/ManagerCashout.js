...
const Formatters = {
    rts: (cashout) => {
        return (
            <tr key={Math.random()}>
                ...
                <td><PersonalVouchers company='rts' workVouchers={cashout.rts_cashout} /></td>
    ...
    pigs: (cashout) => {
        return (
            <tr key={Math.random()}>
                ...
                <td><PersonalVouchers company='pigs' workVouchers={cashout.pigs_cashout} /></td>
    ...
    both: (cashout) => {
        return (
            <tr key={Math.random()}>
                <td><FormattedNumber num={cashout.pigs_cashout + cashout.rts_cashout} /></td>
                <td><PersonalVouchers company='both' workVouchers={cashout.rts_cashout + cashout.pigs_cashout} /></td>
                <td>$<FormattedNumber num={cashout.pigs_cashout_worth + cashout.rts_cashout_worth} /></td>
                <td>$<FormattedNumber num={(cashout.pigs_cashout + cashout.rts_cashout) * 10000} /></td>
                <td>$<FormattedNumber num={Math.floor((((cashout.pigs_cashout + cashout.rts_cashout) * 10000)-(cashout.pigs_cashout_worth + cashout.rts_cashout_worth)) * 0.5)} /></td>
                <td>$<FormattedNumber num={Math.floor((((cashout.pigs_cashout + cashout.rts_cashout) * 10000)-(cashout.pigs_cashout_worth + cashout.rts_cashout_worth)) * 0.5) + (cashout.pigs_cashout_worth + cashout.rts_cashout_worth)} /></td>
                <td>$<FormattedNumber num={cashout.total_money} /></td>
            </tr>
        )
    }
