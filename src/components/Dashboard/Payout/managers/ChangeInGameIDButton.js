...
import { Button, Modal, ModalBody, ModalHeader, ModalFooter, Form, FormGroup, Label, Input, FormFeedback } from 'reactstrap';
                ...
                <ModalBody>
                    <Form>
                        <FormGroup>
                            ...
                            <Input invalid={!gameID || gameID < 1} type="number" placeholder={props.game_id} value={gameID} onChange={(ev) => setGameID(parseInt(ev.target.value))} />
                            <FormFeedback>
